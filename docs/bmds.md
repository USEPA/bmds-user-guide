...
```
[^3]: LOUD = ***L***everaging ***O***ptimized ***U***nified prior ***D***istributions, MCMC = Markov Chain Monte Carlo, see [Bayesian Parameter Estimation](./continuous-bayesian.md#bayesian-parameter-estimation) for more information 

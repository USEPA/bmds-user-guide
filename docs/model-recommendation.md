...
:::{warning}
When changing the decision logic, an experienced user or statistician should be consulted to ensure the criteria selections are reasonable. **Any** changes to the BMDS default logic should be noted in any results or reports.
:::
